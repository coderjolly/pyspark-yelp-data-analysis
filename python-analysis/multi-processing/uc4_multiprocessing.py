...
def chunk_query(df):
    uc4 = df[df['elite'] != '']
    uc4['total_compliments'] = uc4.apply(complimentsum, axis=1)
    uc4 = uc4[(uc4['fans'] > 100) | (uc4['review_count'] > 500) | (uc4['total_compliments'] > 1000)]
    uc4 = uc4[uc4['average_stars'] > 4.0]
    uc4 = uc4[['business_name', 'review_count', 'categories', 'city', 'state']]
    return uc4
